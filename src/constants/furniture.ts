...
export const FURNITURE_PRESETS: FurniturePreset[] = [
  ...
  { type: "tv", name: "TV", width: 120, height: 24, color: "#747f8d", hint: "벽걸이 혹은 낮은 TV 기준" },
  { type: "fridge", name: "냉장고", width: 70, height: 70, color: "#a4a3a1", hint: "1도어 냉장고" },
  { type: "dishwasher", name: "식기세척기", width: 60, height: 60, color: "#adb7c0", hint: "빌트인 또는 소형 식세기" },
  { type: "washer", name: "세탁기", width: 65, height: 65, color: "#b5b5b4", hint: "드럼 세탁기" },
  { type: "robotVacuum", name: "로봇청소기", width: 38, height: 38, color: "#91979f", hint: "자동 청소 로봇" },
