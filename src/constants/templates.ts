...
export const ROOM_TEMPLATES: Template[] = [
  {
    ...
    starterFurniture: [
      ...
      createFurnitureItem("washer", { x: 260, y: 0, width: 70, height: 70, name: "세탁기" }),
      ...
      createFurnitureItem("desk", { x: 272, y: 122, width: 58, height: 98, rotation: 90 }),
      createFurnitureItem("custom", { x: 152, y: 216, width: 70, height: 110, name: "식탁", color: "#f0b43c" }),
      createFurnitureItem("custom", { x: 272, y: 224, width: 58, height: 72, name: "옷수납", color: "#f0b43c" }),
      createFurnitureItem("custom", { x: 272, y: 302, width: 58, height: 94, name: "행거", color: "#f0b43c" }),
